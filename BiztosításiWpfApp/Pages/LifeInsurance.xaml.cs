    ...
    public partial class LifeInsurance : Page
    {
        ...
        private void btnContract_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (int.TryParse(tbAmount.Text, out number) && int.TryParse(tbMonth.Text, out number))
            {
                ...
                Logger.Log("Szerződés kötés (életbiztosítás), ID: " + GlobalData.currentUserId);
                tbAmount.Text = "";
                tbMonth.Text = "";
            }
            else
            {
                MessageBox.Show("A mezőkbe csak számértéket adhat meg!", "Hiba", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
